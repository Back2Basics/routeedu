...
import redu_forms as forms

class IntroHandler(BaseHandler):
    """ Front Page Pre-login introduction """ 

    def get(self):
        return self.render_template('redu_intro.html')
...
class GoalSearchHandler(BaseHandler):
    ...
    def post(self):
        ...
        params = {}
        self.render_template('redu_showConcepts.html',**params)
